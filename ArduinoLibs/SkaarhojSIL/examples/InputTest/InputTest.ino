/*****************
 * This example will first run the LED test sequence on SkaarhojSIL board with address 0 on the I2C bus 
...
void setup() { 
  ...
  // Set up the board:
  board.begin(7);  // Address 7, solder jumper all ON
...
uint8_t nextButtonColor(int i) {
  ...
  return buttonColorTracking[i-1]%9;
}
