 ...
 */
bool ClientBMDSmartView::isReady()	{
 ...
 */
void ClientBMDSmartView::_sendCmdRequest(uint8_t monId, const char *str)	{
...
uint8_t ClientBMDSmartView::getBrightness(uint8_t monId) {
...
uint8_t ClientBMDSmartView::getContrast(uint8_t monId) {
...
uint8_t ClientBMDSmartView::getSaturation(uint8_t monId) {
 ...
 */
bool ClientBMDSmartView::getIdentify(uint8_t monId)	{
...
uint8_t ClientBMDSmartView::getBorder(uint8_t monId) {
...
uint8_t ClientBMDSmartView::getWidescreenSD(uint8_t monId) {
 ...
 */
uint8_t ClientBMDSmartView::getScopeMode(uint8_t monId)	{
...
uint8_t ClientBMDSmartView::getAudioChannel(uint8_t monId) {
