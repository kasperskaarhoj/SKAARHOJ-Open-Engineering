...
#ifndef ClientSonyDeckControlUDP_h
#define ClientSonyDeckControlUDP_h
...
#define ClientSonyDeckControlUDP_BUFFERLEN 15

class ClientSonyDeckControlUDP : public SkaarhojUDPClient 
{
  private:
  	uint8_t _binarybuffer[ClientSonyDeckControlUDP_BUFFERLEN];
...
/********************************
* ClientSonyDeckControlUDP State methods
...
/********************************
 * ClientSonyDeckControlUDP Command methods
