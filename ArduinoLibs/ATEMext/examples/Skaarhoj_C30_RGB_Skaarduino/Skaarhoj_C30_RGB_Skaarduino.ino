...
void webDefaultView(WebServer &server, WebServer::ConnectionType type)
{
  ...
  server << F("<h1>Mixer type:</h1><p>");

  server << F("<select name='flipflop") << i << F(":'div style='width:90px;>");
  server << F("<option value='0'></option>");
  server << F("<option value='") << 0 << F("'") << (EEPROM.read(90) == 0 ? F(" selected='selected'") : F("")) << F(">Pvw/Pgm") << F("</option>");
  server << F("<option value='") << 1 << F("'") << (EEPROM.read(90) == 1 ? F(" selected='selected'") : F("")) << F(">FlipFlop") << F("</option>");
  server << F("</select></td>");
  ...
  for (i = 1; i <= 10; ++i)
  {
    ...
    server << F("<option value='") << 42 << F("'") << (EEPROM.read(200 + i) == 42 ? F(" selected='selected'") : F("")) << F(">PvwBars") << F("</option>");
    server << F("<option value='") << 43 << F("'") << (EEPROM.read(200 + i) == 43 ? F(" selected='selected'") : F("")) << F(">PvwColor1") << F("</option>");
    server << F("<option value='") << 44 << F("'") << (EEPROM.read(200 + i) == 44 ? F(" selected='selected'") : F("")) << F(">PvwColor2") << F("</option>");
    server << F("<option value='") << 45 << F("'") << (EEPROM.read(200 + i) == 45 ? F(" selected='selected'") : F("")) << F(">PvwMedia1") << F("</option>");
    server << F("<option value='") << 46 << F("'") << (EEPROM.read(200 + i) == 46 ? F(" selected='selected'") : F("")) << F(">PvwMedia1Key") << F("</option>");
    server << F("<option value='") << 47 << F("'") << (EEPROM.read(200 + i) == 47 ? F(" selected='selected'") : F("")) << F(">PvwMedia2") << F("</option>");
    server << F("<option value='") << 48 << F("'") << (EEPROM.read(200 + i) == 48 ? F(" selected='selected'") : F("")) << F(">PvwMedia2Key") << F("</option>");
    server << F("<option value='") << 49 << F("'") << (EEPROM.read(200 + i) == 49 ? F(" selected='selected'") : F("")) << F(">PvwSuperSource") << F("</option>");
    server << F("<option value='") << 50 << F("'") << (EEPROM.read(200 + i) == 50 ? F(" selected='selected'") : F("")) << F(">PgmBlack") << F("</option>");
    server << F("<option value='") << 51 << F("'") << (EEPROM.read(200 + i) == 51 ? F(" selected='selected'") : F("")) << F(">PgmBars") << F("</option>");
    server << F("<option value='") << 52 << F("'") << (EEPROM.read(200 + i) == 52 ? F(" selected='selected'") : F("")) << F(">PgmColor1") << F("</option>");
    server << F("<option value='") << 53 << F("'") << (EEPROM.read(200 + i) == 53 ? F(" selected='selected'") : F("")) << F(">PgmColor2") << F("</option>");
    server << F("<option value='") << 54 << F("'") << (EEPROM.read(200 + i) == 54 ? F(" selected='selected'") : F("")) << F(">PgmMedia1") << F("</option>");
    server << F("<option value='") << 55 << F("'") << (EEPROM.read(200 + i) == 55 ? F(" selected='selected'") : F("")) << F(">PgmMedia1Key") << F("</option>");
    server << F("<option value='") << 56 << F("'") << (EEPROM.read(200 + i) == 56 ? F(" selected='selected'") : F("")) << F(">PgmMedia2") << F("</option>");
    server << F("<option value='") << 57 << F("'") << (EEPROM.read(200 + i) == 57 ? F(" selected='selected'") : F("")) << F(">PgmMedia2Key") << F("</option>");
    server << F("<option value='") << 58 << F("'") << (EEPROM.read(200 + i) == 58 ? F(" selected='selected'") : F("")) << F(">PgmSuperSource") << F("</option>");

    server << F("<option value='") << 254 << F("'") << (EEPROM.read(200 + i) == 254 ? F(" selected='selected'") : F("")) << F(">PvwMultiviewer") << F("</option>");
    server << F("<option value='") << 255 << F("'") << (EEPROM.read(200 + i) == 255 ? F(" selected='selected'") : F("")) << F(">PgmMultiviewer") << F("</option>");
  ...
  for (i = 1; i <= 10; ++i)
  {
    ...
    server << F("<option value='") << 2 << F("'") << (EEPROM.read(210 + i) == 2 ? F(" selected='selected'") : F("")) << F(">USK1On") << F("</option>");
    server << F("<option value='") << 3 << F("'") << (EEPROM.read(210 + i) == 3 ? F(" selected='selected'") : F("")) << F(">USK1Off") << F("</option>");
    server << F("<option value='") << 4 << F("'") << (EEPROM.read(210 + i) == 4 ? F(" selected='selected'") : F("")) << F(">USK2") << F("</option>");
    server << F("<option value='") << 5 << F("'") << (EEPROM.read(210 + i) == 5 ? F(" selected='selected'") : F("")) << F(">USK2On") << F("</option>");
    server << F("<option value='") << 6 << F("'") << (EEPROM.read(210 + i) == 6 ? F(" selected='selected'") : F("")) << F(">USK2Off") << F("</option>");
    server << F("<option value='") << 7 << F("'") << (EEPROM.read(210 + i) == 7 ? F(" selected='selected'") : F("")) << F(">USK3") << F("</option>");
    server << F("<option value='") << 8 << F("'") << (EEPROM.read(210 + i) == 8 ? F(" selected='selected'") : F("")) << F(">USK3On") << F("</option>");
    server << F("<option value='") << 9 << F("'") << (EEPROM.read(210 + i) == 9 ? F(" selected='selected'") : F("")) << F(">USK3Off") << F("</option>");
    server << F("<option value='") << 10 << F("'") << (EEPROM.read(210 + i) == 10 ? F(" selected='selected'") : F("")) << F(">USK4") << F("</option>");
    server << F("<option value='") << 11 << F("'") << (EEPROM.read(210 + i) == 11 ? F(" selected='selected'") : F("")) << F(">USK4On") << F("</option>");
    server << F("<option value='") << 12 << F("'") << (EEPROM.read(210 + i) == 12 ? F(" selected='selected'") : F("")) << F(">USK4Off") << F("</option>");

    // DSK 1-2 on/off
    server << F("<option value='") << 13 << F("'") << (EEPROM.read(210 + i) == 13 ? F(" selected='selected'") : F("")) << F(">DSK1") << F("</option>");
    server << F("<option value='") << 14 << F("'") << (EEPROM.read(210 + i) == 14 ? F(" selected='selected'") : F("")) << F(">DSK1On") << F("</option>");
    server << F("<option value='") << 15 << F("'") << (EEPROM.read(210 + i) == 15 ? F(" selected='selected'") : F("")) << F(">DSK1Off") << F("</option>");
    server << F("<option value='") << 16 << F("'") << (EEPROM.read(210 + i) == 16 ? F(" selected='selected'") : F("")) << F(">DSK1Auto") << F("</option>");
    server << F("<option value='") << 17 << F("'") << (EEPROM.read(210 + i) == 17 ? F(" selected='selected'") : F("")) << F(">DSK2") << F("</option>");
    server << F("<option value='") << 18 << F("'") << (EEPROM.read(210 + i) == 18 ? F(" selected='selected'") : F("")) << F(">DSK2On") << F("</option>");
    server << F("<option value='") << 19 << F("'") << (EEPROM.read(210 + i) == 19 ? F(" selected='selected'") : F("")) << F(">DSK2Off") << F("</option>");
    server << F("<option value='") << 20 << F("'") << (EEPROM.read(210 + i) == 20 ? F(" selected='selected'") : F("")) << F(">DSK2Auto") << F("</option>");

    // Others
    server << F("<option value='") << 21 << F("'") << (EEPROM.read(210 + i) == 21 ? F(" selected='selected'") : F("")) << F(">Keys Off") << F("</option>");
    server << F("<option value='") << 22 << F("'") << (EEPROM.read(210 + i) == 22 ? F(" selected='selected'") : F("")) << F(">Cut") << F("</option>");
    server << F("<option value='") << 23 << F("'") << (EEPROM.read(210 + i) == 23 ? F(" selected='selected'") : F("")) << F(">Auto") << F("</option>");
    server << F("<option value='") << 24 << F("'") << (EEPROM.read(210 + i) == 24 ? F(" selected='selected'") : F("")) << F(">FTB") << F("</option>");

    server << F("<option value='") << 25 << F("'") << (EEPROM.read(210 + i) == 25 ? F(" selected='selected'") : F("")) << F(">PIP") << F("</option>");
    server << F("<option value='") << 26 << F("'") << (EEPROM.read(210 + i) == 26 ? F(" selected='selected'") : F("")) << F(">VGA+PIP") << F("</option>");

    server << F("</select></td>");
  }
  server << F("</tr></n>");

  // Set third routing for INPUT buttons
  for (i = 1; i <= 10; ++i)
  {
    server << F("<td></p>");
    ...
    // Macro 1-20
    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(220 + i) == j ? F(" selected='selected'") : F("")) << F(">Macro ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux1") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(230 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");
    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(230 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux2") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(240 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");

    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(240 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux3") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(250 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");

    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(250 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux4") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(260 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");

    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(260 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux5") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(270 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");

    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(270 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
  ...
  {
    server << F("<td></p>");
    server << F("<select name='Aux6") << i << F(":'div style='width:78px;>");
    server << F("<option value='0'></option>");

    server << F("<option value='") << 0 << F("'") << (EEPROM.read(280 + i) == 0 ? F(" selected='selected'") : F("")) << F("> \t") << F("</option>");

    for (uint8_t j = 1; j <= 20; j++)  {
      server << F("<option value='") << j << F("'") << (EEPROM.read(280 + i) == j ? F(" selected='selected'") : F("")) << F(">Input ") << j << F("</option>");
    }
...
uint8_t buttons1function[10];
uint8_t buttons2function[10];
uint8_t buttons3function[10];
uint8_t aux1[10];
uint8_t aux2[10];
uint8_t aux3[10];
uint8_t aux4[10];
...
void setup() {
  ...
  inputSelect.begin(0, false, false);
  ...
  if (isConfigMode)  {
    ...
    for (uint8_t i = 1; i <= 10; i++) {
      buttons1function[i - 1] = (EEPROM.read(200 + i));
      buttons2function[i - 1] = (EEPROM.read(210 + i));
      buttons3function[i - 1] = (EEPROM.read(220 + i));
      aux1[i - 1] = (EEPROM.read(230 + i));
      aux2[i - 1] = (EEPROM.read(240 + i));
      aux3[i - 1] = (EEPROM.read(250 + i));
      aux4[i - 1] = (EEPROM.read(260 + i));
      aux5[i - 1] = (EEPROM.read(270 + i));
      aux6[i - 1] = (EEPROM.read(280 + i));
    }
    flipflop = EEPROM.read(90) == 1 ? true : false;
  ...
  if (isConfigMode)  {
    ...
    if (AtemSwitcher.hasInitialized())  {
      if (!AtemOnline)  {
        ...
        inputSelect.setDefaultColor(9);  // Dimmed by default
        inputSelect.setButtonColorsToDefault();
...
uint8_t buttonTracking[] = {9, 1, 2, 3, 7, 10, 4, 5, 6, 8};
    ...
    switch (buttons1function[i - 1]) {
      case 0:
        switch (buttons2function[i - 1]) {
                ...
                switch (aux1[i - 1]) {
                  case 0:
                    switch (aux2[i - 1]) {
                        ...
                        switch (aux3[i - 1]) {
                          case 0:
                            switch (aux4[i - 1]) {
                                ...
                                switch (aux5[i - 1]) {
                                  case 0:
                                    switch (aux6[i - 1]) {
                                      ...
                                      case 19:
                                      case 20:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == aux6[i - 1] ? 6 : 9);
                                        break;
                                      case 21:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 0 ? 6 : 9);
                                        break;
                                      case 22:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 1000 ? 6 : 9);
                                        break;
                                      case 23:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 2001 ? 6 : 9);
                                        break;
                                      case 24:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 2002 ? 6 : 9);
                                        break;
                                      case 25:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 3010 ? 6 : 9);
                                        break;
                                      case 26:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 3011 ? 6 : 9);
                                        break;
                                      case 27:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 3020 ? 6 : 9);
                                        break;
                                      case 28:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 3021 ? 6 : 9);
                                        break;
                                      case 29:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 7001 ? 6 : 9);
                                        break;
                                      case 30:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 7002 ? 6 : 9);
                                        break;
                                      case 31:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 6000 ? 6 : 9);
                                        break;
                                      case 32:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 10010 ? 6 : 9);
                                        break;
                                      case 33:
                                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(5) == 10011 ? 6 : 9);
                                        break;
                                    }
                                    break;
                                  case 1:
                                  ...
                                  case 19:
                                  case 20:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == aux5[i - 1] ? 6 : 9);
                                    break;
                                  case 21:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 0 ? 6 : 9);
                                    break;
                                  case 22:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 1000 ? 6 : 9);
                                    break;
                                  case 23:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 2001 ? 6 : 9);
                                    break;
                                  case 24:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 2002 ? 6 : 9);
                                    break;
                                  case 25:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 3010 ? 6 : 9);
                                    break;
                                  case 26:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 3011 ? 6 : 9);
                                    break;
                                  case 27:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 3020 ? 6 : 9);
                                    break;
                                  case 28:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 3021 ? 6 : 9);
                                    break;
                                  case 29:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 7001 ? 6 : 9);
                                    break;
                                  case 30:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 7002 ? 6 : 9);
                                    break;
                                  case 31:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 6000 ? 6 : 9);
                                    break;
                                  case 32:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 10010 ? 6 : 9);
                                    break;
                                  case 33:
                                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(4) == 10011 ? 6 : 9);
                                    break;
                                }
                                break;
                              case 1:
                              ...
                              case 19:
                              case 20:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == aux4[i - 1] ? 6 : 9);
                                break;
                              case 21:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 0 ? 6 : 9);
                                break;
                              case 22:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 1000 ? 6 : 9);
                                break;
                              case 23:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 2001 ? 6 : 9);
                                break;
                              case 24:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 2002 ? 6 : 9);
                                break;
                              case 25:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 3010 ? 6 : 9);
                                break;
                              case 26:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 3011 ? 6 : 9);
                                break;
                              case 27:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 3020 ? 6 : 9);
                                break;
                              case 28:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 3021 ? 6 : 9);
                                break;
                              case 29:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 7001 ? 6 : 9);
                                break;
                              case 30:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 7002 ? 6 : 9);
                                break;
                              case 31:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 6000 ? 6 : 9);
                                break;
                              case 32:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 10010 ? 6 : 9);
                                break;
                              case 33:
                                inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(3) == 10011 ? 6 : 9);
                                break;
                            }
                            break;
                          case 1:
                          ...
                          case 19:
                          case 20:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == aux3[i - 1] ? 6 : 9);
                            break;
                          case 21:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 0 ? 6 : 9);
                            break;
                          case 22:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 1000 ? 6 : 9);
                            break;
                          case 23:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 2001 ? 6 : 9);
                            break;
                          case 24:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 2002 ? 6 : 9);
                            break;
                          case 25:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 3010 ? 6 : 9);
                            break;
                          case 26:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 3011 ? 6 : 9);
                            break;
                          case 27:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 3020 ? 6 : 9);
                            break;
                          case 28:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 3021 ? 6 : 9);
                            break;
                          case 29:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 7001 ? 6 : 9);
                            break;
                          case 30:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 7002 ? 6 : 9);
                            break;
                          case 31:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 6000 ? 6 : 9);
                            break;
                          case 32:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 10010 ? 6 : 9);
                            break;
                          case 33:
                            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(2) == 10011 ? 6 : 9);
                            break;
                        }
                        break;
                      case 1:
                      ...
                      case 19:
                      case 20:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == aux2[i - 1] ? 6 : 9);
                        break;
                      case 21:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 0 ? 6 : 9);
                        break;
                      case 22:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 1000 ? 6 : 9);
                        break;
                      case 23:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 2001 ? 6 : 9);
                        break;
                      case 24:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 2002 ? 6 : 9);
                        break;
                      case 25:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 3010 ? 6 : 9);
                        break;
                      case 26:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 3011 ? 6 : 9);
                        break;
                      case 27:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 3020 ? 6 : 9);
                        break;
                      case 28:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 3021 ? 6 : 9);
                        break;
                      case 29:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 7001 ? 6 : 9);
                        break;
                      case 30:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 7002 ? 6 : 9);
                        break;
                      case 31:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 6000 ? 6 : 9);
                        break;
                      case 32:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 10010 ? 6 : 9);
                        break;
                      case 33:
                        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(1) == 10011 ? 6 : 9);
                        break;
                    }
                    break;
                  case 1:
                  ...
                  case 19:
                  case 20:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == aux1[i - 1] ? 6 : 9);
                    break;
                  case 21:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 0 ? 6 : 9);
                    break;
                  case 22:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 1000 ? 6 : 9);
                    break;
                  case 23:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 2001 ? 6 : 9);
                    break;
                  case 24:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 2002 ? 6 : 9);
                    break;
                  case 25:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 3010 ? 6 : 9);
                    break;
                  case 26:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 3011 ? 6 : 9);
                    break;
                  case 27:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 3020 ? 6 : 9);
                    break;
                  case 28:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 3021 ? 6 : 9);
                    break;
                  case 29:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 7001 ? 6 : 9);
                    break;
                  case 30:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 7002 ? 6 : 9);
                    break;
                  case 31:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 6000 ? 6 : 9);
                    break;
                  case 32:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 10010 ? 6 : 9);
                    break;
                  case 33:
                    inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getAuxSourceInput(0) == 10011 ? 6 : 9);
                    break;
                }
                break;
              case 1:
                  ...
                  if (AtemSwitcher.getMacroRunStatusState())  {  // Something is running...
                    if (AtemSwitcher.getMacroRunStatusIndex() == buttons3function[i - 1] - 1)  {
                      if (AtemSwitcher.getMacroRunStatusState() & B10)  {  // Waiting...
                        inputSelect.setButtonColor(buttonTracking[i - 1], millis() & 512 ? 5 : 4);
                      } else {  // Just running:
                        inputSelect.setButtonColor(buttonTracking[i - 1], 2);
                      }
                    } else {
                      inputSelect.setButtonColor(buttonTracking[i - 1], 0);
                    }
                  } else {  // All is stopped:
                    inputSelect.setButtonColor(buttonTracking[i - 1], 5);
                  }
                } else {
                  inputSelect.setButtonColor(buttonTracking[i - 1], 0);
                }
          ...
          case 2:
          case 3:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getKeyerOnAirEnabled(0, 0) ? 4 : 9);
            break;
          case 4:
          case 5:
          case 6:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getKeyerOnAirEnabled(0, 1) ? 4 : 9);
            break;
          case 7:
          case 8:
          case 9:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getKeyerOnAirEnabled(0, 2) ? 4 : 9);
            break;
          case 10:
          case 11:
          case 12:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getKeyerOnAirEnabled(0, 3) ? 4 : 9);
            break;
          case 13:
          case 14:
          case 15:
          case 16:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getDownstreamKeyerOnAir(0) ? 4 : 9);
            break;
          case 17:
          case 18:
          case 19:
          case 20:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getDownstreamKeyerOnAir(1) ? 4 : 9);
            break;
          case 21:
            inputSelect.setButtonColor(buttonTracking[i - 1], (AtemSwitcher.getKeyerOnAirEnabled(0, 0) || AtemSwitcher.getKeyerOnAirEnabled(0, 1) || AtemSwitcher.getKeyerOnAirEnabled(0, 2) || AtemSwitcher.getKeyerOnAirEnabled(0, 3) || AtemSwitcher.getDownstreamKeyerOnAir(0) || AtemSwitcher.getDownstreamKeyerOnAir(1)) ? 4 : 9);
            break;
          case 22:
            inputSelect.setButtonColor(buttonTracking[i - 1], inputSelect.buttonIsPressed(buttonTracking[i - 1]) ? 6 : 9);
            break;
          case 23:
            inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getTransitionPosition(0) > 0 ? 6 : 9);
            break;
          case 24:
            if (AtemSwitcher.getFadeToBlackStateInTransition(0))  {  // Setting button color. This is a more complex example which includes blinking during execution:
              ...
              if ((unsigned long)millis() & B10000000)  {
                ...
                inputSelect.setButtonColor(buttonTracking[i - 1], 9);
              }
            }
            else {
              inputSelect.setButtonColor(buttonTracking[i - 1], 9);
          ...
          case 25:
            ...
            break;
          case 26:
            inputSelect.setButtonColor(buttonTracking[i - 1], preVGA_active ? 4 : 9);
            break;
        }
        break;
      case 1:
      ...
      case 20:
        if (flipflop) {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == buttons1function[i - 1] ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == buttons1function[i - 1] ? 3 : 9);
        } else {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getPreviewInputVideoSource(0) == buttons1function[i - 1] ? 3 : 9);
        }
        break;
      case 21:
      case 22:
      ...
      case 40:
        if (flipflop) {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == buttons1function[i - 1] - 20 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == buttons1function[i - 1] - 20 ? 3 : 9);
        } else {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == buttons1function[i - 1] - 20 ? 2 : 9);
        }
        break;
      case 41:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 0 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 0 ? 3 : 9);
        break;
      case 42:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 1000 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 1000 ? 3 : 9);
        break;
      case 43:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 2001 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 2001 ? 3 : 9);
        break;
      case 44:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 2002 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 2002 ? 3 : 9);
        break;
      case 45:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 3010 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 3010 ? 3 : 9);
        break;
      case 46:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 3011 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 3011 ? 3 : 9);
        break;
      case 47:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 3020 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 3020 ? 3 : 9);
        break;
      case 48:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop && AtemSwitcher.getProgramInputVideoSource(0) == 3021 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 3021 ? 3 : 9);
        break;
      case 49:
        inputSelect.setButtonColor(buttonTracking[i - 1], flipflop &&  AtemSwitcher.getProgramInputVideoSource(0) == 6000 ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == 6000 ? 3 : 9);
        break;
      case 50:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 0 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 0 ? 3 : 9);
        break;
      case 51:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 1000 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 1000 ? 3 : 9);
        break;
      case 52:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 2001 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 2001 ? 3 : 9);
        break;
      case 53:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 2002 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 2002 ? 3 : 9);
        break;
      case 54:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 3010 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 3010 ? 3 : 9);
        break;
      case 55:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 3011 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 3011 ? 3 : 9);
        break;
      case 56:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 3020 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 3020 ? 3 : 9);
        break;
      case 57:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 3021 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 3021 ? 3 : 9);
        break;
      case 58:
        inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == 6000 ? 2 : flipflop && AtemSwitcher.getPreviewInputVideoSource(0) == 6000 ? 3 : 9);
        break;
      case 254:
        if (flipflop) {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1) ? 2 : AtemSwitcher.getPreviewInputVideoSource(0) == AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1) ? 3 : 9);
        } else {
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getPreviewInputVideoSource(0) == AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1) ? 3 : 9);
        }
        break;
      case 255:
        if (flipflop) {
          ...
          inputSelect.setButtonColor(buttonTracking[i - 1], AtemSwitcher.getProgramInputVideoSource(0) == AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1) ? 2 : 9);
        }
        break;
    }
  }
...
void commandDispatch()  {
  ...
  uint16_t busSelection = inputSelect.buttonDownAll();

  for (uint8_t i = 1; i <= 10; i++)  {
    if (inputSelect.isButtonIn(buttonTracking[i - 1], busSelection))  {
      switch (buttons1function[i - 1]) {
        case 0:
          break;
        case 1:
        ...
        case 19:
        case 20:
          AtemSwitcher.setPreviewInputVideoSource(0, buttons1function[i - 1]);
          break;
        case 21:
        case 22:
        case 23:
        ...
        case 39:
        case 40:
          AtemSwitcher.setProgramInputVideoSource(0, buttons1function[i - 1] - 20);
          break;
        case 41:
        ...
        case 45:
          ...
          break;
        case 46:
          AtemSwitcher.setPreviewInputVideoSource(0, 3011);
          break;
        case 47:
          AtemSwitcher.setPreviewInputVideoSource(0, 3020);
          break;
        case 48:
          AtemSwitcher.setPreviewInputVideoSource(0, 3021);
          break;
        case 49:
          AtemSwitcher.setPreviewInputVideoSource(0, 6000);
          break;
        case 50:
          AtemSwitcher.setProgramInputVideoSource(0, 0);
          break;
        case 51:
          AtemSwitcher.setProgramInputVideoSource(0, 1000);
          break;
        case 52:
          AtemSwitcher.setProgramInputVideoSource(0, 2001);
          break;
        case 53:
          AtemSwitcher.setProgramInputVideoSource(0, 2002);
          break;
        case 54:
          AtemSwitcher.setProgramInputVideoSource(0, 3010);
          break;
        case 55:
          AtemSwitcher.setProgramInputVideoSource(0, 3011);
          break;
        case 56:
          AtemSwitcher.setProgramInputVideoSource(0, 3020);
          break;
        case 57:
          AtemSwitcher.setProgramInputVideoSource(0, 3021);
          break;
        case 58:
          AtemSwitcher.setProgramInputVideoSource(0, 6000);
          break;
        case 254:
          AtemSwitcher.setPreviewInputVideoSource(0, AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1));
          break;
        case 255:
          AtemSwitcher.setProgramInputVideoSource(0, AtemSwitcher.getMultiViewerInputVideoSource(0, i + 1));
          break;
      }
      switch (buttons2function[i - 1]) {
        case 0:
        ...
        case 24:
          ...
          break;
        case 25:
          inputSelect.setButtonColor(buttonTracking[i - 1], 4);
          commandPIP();
          break;
        case 26:
          commandPIPVGA();
      ...
      switch (aux1[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(0, aux1[i - 1]);
          break;
        case 21:
      ...
      switch (aux2[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(1, aux2[i - 1]);
          break;
        case 21:
      ...
      switch (aux3[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(2, aux3[i - 1]);
          break;
        case 21:
      ...
      switch (aux4[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(3, aux4[i - 1]);
          break;
        case 21:
      ...
      switch (aux5[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(4, aux5[i - 1]);
          break;
        case 21:
      ...
      switch (aux6[i - 1]) {
        ...
        case 19:
        case 20:
          AtemSwitcher.setAuxSourceInput(5, aux6[i - 1]);
          break;
        case 21:
...
void runTest() {
  inputSelect.testProgramme(1023);
  lDelay(20);
}
