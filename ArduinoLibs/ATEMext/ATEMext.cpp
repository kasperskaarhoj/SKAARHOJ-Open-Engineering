...
void ATEMext::setCameraControlVideomode(uint8_t input, uint8_t fps, uint8_t resolution, uint8_t interlaced) {
	...
	void ATEMext::setCameraControlLift(uint8_t input, int liftR, int liftG, int liftB, int liftY) {
  		_prepareCommandPacket(PSTR("CCmd"),24);
	...
	void ATEMext::setCameraControlHueSaturation(uint8_t input, int hue, int saturation) {
		...
		void ATEMext::_parseGetCommands(const char *cmdStr)	{
			 ...
			 * longName 	
			 */
			void ATEMext::setInputLongName(uint16_t videoSource, char *  longName) {
			 ...
			 * shortName 	
			 */
			void ATEMext::setInputShortName(uint16_t videoSource, char *  shortName) {
			 ...
			 * externalPortType 	
			 */
			void ATEMext::setInputExternalPortType(uint16_t videoSource, uint16_t externalPortType) {
			 ...
			 */
			void ATEMext::setMultiViewerPropertiesLayout(uint8_t multiViewer, uint8_t layout) {
			 ...
			 * windowIndex 	0-9
			 */
			uint16_t ATEMext::getMultiViewerInputVideoSource(uint8_t multiViewer, uint8_t windowIndex) {
			 ...
			 * videoSource 	(See video source list)
			 */
			void ATEMext::setMultiViewerInputVideoSource(uint8_t multiViewer, uint8_t windowIndex, uint16_t videoSource) {
			 ...
			 * videoSource 	(See video source list)
			 */
			void ATEMext::setProgramInputVideoSource(uint8_t mE, uint16_t videoSource) {
			 ...
			 * videoSource 	(See video source list)
			 */
			void ATEMext::setPreviewInputVideoSource(uint8_t mE, uint16_t videoSource) {
			 ...
			 */
			void ATEMext::setTransitionNextTransition(uint8_t mE, uint8_t nextTransition) {
			 ...
			 */
			void ATEMext::setTransitionDipInput(uint8_t mE, uint16_t input) {
			 ...
			 */
			void ATEMext::setTransitionWipePattern(uint8_t mE, uint8_t pattern) {
			 ...
			 * width 	0-10000: 0-100%
			 */
			void ATEMext::setTransitionWipeWidth(uint8_t mE, uint16_t width) {
			 ...
			 */
			void ATEMext::setTransitionWipeFillSource(uint8_t mE, uint16_t fillSource) {
			 ...
			 */
			void ATEMext::setTransitionWipeSymmetry(uint8_t mE, uint16_t symmetry) {
			 ...
			 */
			void ATEMext::setTransitionWipeSoftness(uint8_t mE, uint16_t softness) {
			 ...
			 */
			void ATEMext::setTransitionWipePositionX(uint8_t mE, uint16_t positionX) {
			 ...
			 */
			void ATEMext::setTransitionWipeFlipFlop(uint8_t mE, bool flipFlop) {
			 ...
			 * fillSource 	(See video source list)
			 */
			void ATEMext::setTransitionDVEFillSource(uint8_t mE, uint16_t fillSource) {
			 ...
			 */
			void ATEMext::setTransitionDVEKeySource(uint8_t mE, uint16_t keySource) {
			 ...
			 */
			void ATEMext::setTransitionDVEEnableKey(uint8_t mE, bool enableKey) {
			 ...
			 */
			void ATEMext::setTransitionDVEPreMultiplied(uint8_t mE, bool preMultiplied) {
			 ...
			 */
			void ATEMext::setTransitionStingerSource(uint8_t mE, uint8_t source) {
			 ...
			 * enabled 	Bit 0: On/Off
			 */
			void ATEMext::setKeyerOnAirEnabled(uint8_t mE, uint8_t keyer, bool enabled) {
			 ...
			 */
			void ATEMext::setKeyerType(uint8_t mE, uint8_t keyer, uint8_t type) {
			 ...
			 */
			void ATEMext::setKeyerFlyEnabled(uint8_t mE, uint8_t keyer, bool flyEnabled) {
			 ...
			 * masked 	Bit 0: On/Off
			 */
			void ATEMext::setKeyerMasked(uint8_t mE, uint8_t keyer, bool masked) {
			 ...
			 * fillSource 	(See video source list)
			 */
			void ATEMext::setKeyerFillSource(uint8_t mE, uint8_t keyer, uint16_t fillSource) {
			 ...
			 * keySource 	(See video source list)
			 */
			void ATEMext::setKeyerKeySource(uint8_t mE, uint8_t keyer, uint16_t keySource) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			bool ATEMext::getKeyLumaPreMultiplied(uint8_t mE, uint8_t keyer) {
			 ...
			 * preMultiplied 	Bit 0: On/Off
			 */
			void ATEMext::setKeyLumaPreMultiplied(uint8_t mE, uint8_t keyer, bool preMultiplied) {
			 ...
			 * invertKey 	Bit 0: On/Off
			 */
			void ATEMext::setKeyLumaInvertKey(uint8_t mE, uint8_t keyer, bool invertKey) {
			 ...
			 * lift 	0-1000: 0-100%
			 */
			void ATEMext::setKeyChromaLift(uint8_t mE, uint8_t keyer, uint16_t lift) {
			 ...
			 * narrow 	Bit 0: On/Off
			 */
			void ATEMext::setKeyChromaNarrow(uint8_t mE, uint8_t keyer, bool narrow) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyPatternPattern(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyPatternSymmetry(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyPatternSoftness(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyPatternPositionX(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyPatternPositionY(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			bool ATEMext::getKeyPatternInvertPattern(uint8_t mE, uint8_t keyer) {
			 ...
			 * pattern 	0-17: Pattern Styles
			 */
			void ATEMext::setKeyPatternPattern(uint8_t mE, uint8_t keyer, uint8_t pattern) {
			 ...
			 * size 	0-10000: 0-100%
			 */
			void ATEMext::setKeyPatternSize(uint8_t mE, uint8_t keyer, uint16_t size) {
			 ...
			 * symmetry 	0-10000: 0-100%
			 */
			void ATEMext::setKeyPatternSymmetry(uint8_t mE, uint8_t keyer, uint16_t symmetry) {
			 ...
			 * softness 	0-10000: 0-100%
			 */
			void ATEMext::setKeyPatternSoftness(uint8_t mE, uint8_t keyer, uint16_t softness) {
			 ...
			 * positionX 	0-10000: 0.0-1.0
			 */
			void ATEMext::setKeyPatternPositionX(uint8_t mE, uint8_t keyer, uint16_t positionX) {
			 ...
			 * positionY 	0-10000: 0.0-1.0
			 */
			void ATEMext::setKeyPatternPositionY(uint8_t mE, uint8_t keyer, uint16_t positionY) {
			 ...
			 */
			void ATEMext::setKeyPatternInvertPattern(uint8_t mE, uint8_t keyer, bool invertPattern) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			bool ATEMext::getKeyDVEBorderEnabled(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderBevel(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVEBorderOuterWidth(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVEBorderInnerWidth(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderOuterSoftness(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderInnerSoftness(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderBevelSoftness(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderBevelPosition(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVEBorderOpacity(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVEBorderHue(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVEBorderSaturation(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVEBorderLuma(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint16_t ATEMext::getKeyDVELightSourceDirection(uint8_t mE, uint8_t keyer) {
			 ...
			 * keyer 	0-3: Keyer 1-4
			 */
			uint8_t ATEMext::getKeyDVELightSourceAltitude(uint8_t mE, uint8_t keyer) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderEnabled(uint8_t mE, uint8_t keyer, bool borderEnabled) {
			 ...
			 * shadow 	Bit 0: On/Off
			 */
			void ATEMext::setKeyDVEShadow(uint8_t mE, uint8_t keyer, bool shadow) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderBevel(uint8_t mE, uint8_t keyer, uint8_t borderBevel) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderOuterWidth(uint8_t mE, uint8_t keyer, uint16_t borderOuterWidth) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderInnerWidth(uint8_t mE, uint8_t keyer, uint16_t borderInnerWidth) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderOuterSoftness(uint8_t mE, uint8_t keyer, uint8_t borderOuterSoftness) {
			 ...
			 */
			void ATEMext::setKeyDVEBorderLuma(uint8_t mE, uint8_t keyer, uint16_t borderLuma) {
			 ...
			 */
			void ATEMext::setKeyDVELightSourceDirection(uint8_t mE, uint8_t keyer, uint16_t lightSourceDirection) {
			 ...
			 */
			void ATEMext::setKeyDVELightSourceAltitude(uint8_t mE, uint8_t keyer, uint8_t lightSourceAltitude) {
			 ...
			 * masked 	Bit 0: On/Off
			 */
			void ATEMext::setKeyDVEMasked(uint8_t mE, uint8_t keyer, bool masked) {
			 ...
			 * rate 	1-250: Frames
			 */
			void ATEMext::setKeyDVERate(uint8_t mE, uint8_t keyer, uint8_t rate) {
			 ...
			 * keyFrame 	1: A, 2: B
			 */
			void ATEMext::setKeyerFlyKeyFrame(uint8_t mE, uint8_t keyer, uint8_t keyFrame) {
			 ...
			 */
			void ATEMext::setRunFlyingKeyKeyFrame(uint8_t mE, uint8_t keyer, uint8_t keyFrame) {
			 ...
			 * runtoInfiniteindex 	
			 */
			void ATEMext::setRunFlyingKeyRuntoInfiniteindex(uint8_t mE, uint8_t keyer, uint8_t runtoInfiniteindex) {
			 ...
			 * fillSource 	(See video source list)
			 */
			void ATEMext::setDownstreamKeyerFillSource(uint8_t keyer, uint16_t fillSource) {
			 ...
			 * preMultiplied 	Bit 0: On/Off
			 */
			void ATEMext::setDownstreamKeyerPreMultiplied(uint8_t keyer, bool preMultiplied) {
			 ...
			 * clip 	0-1000: 0-100%
			 */
			void ATEMext::setDownstreamKeyerClip(uint8_t keyer, uint16_t clip) {
			 ...
			 * gain 	0-1000: 0-100%
			 */
			void ATEMext::setDownstreamKeyerGain(uint8_t keyer, uint16_t gain) {
			 ...
			 * invertKey 	Bit 0: On/Off
			 */
			void ATEMext::setDownstreamKeyerInvertKey(uint8_t keyer, bool invertKey) {
			 ...
			 * masked 	Bit 0: On/Off
			 */
			void ATEMext::setDownstreamKeyerMasked(uint8_t keyer, bool masked) {
			 ...
			 * keyer 	0: DSK1, 1: DSK2
			 */
			bool ATEMext::getDownstreamKeyerIsAutoTransitioning(uint8_t keyer) {
			 ...
			 * keyer 	0: DSK1, 1: DSK2
			 */
			uint8_t ATEMext::getDownstreamKeyerFramesRemaining(uint8_t keyer) {
			 ...
			 * onAir 	Bit 0: On/Off
			 */
			void ATEMext::setDownstreamKeyerOnAir(uint8_t keyer, bool onAir) {
			 ...
			 * mE 	0: ME1, 1: ME2
			 */
			uint8_t ATEMext::getFadeToBlackStateFramesRemaining(uint8_t mE) {
			 ...
			 * input 	(See video source list)
			 */
			void ATEMext::setAuxSourceInput(uint8_t aUXChannel, uint16_t input) {
			 ...
			 */
			void ATEMext::setClipPlayerPlaying(uint8_t mediaPlayer, bool playing) {
			 ...
			 * loop 	Bit 0: On/Off
			 */
			void ATEMext::setClipPlayerLoop(uint8_t mediaPlayer, bool loop) {
			 ...
			 */
			void ATEMext::setClipPlayerAtBeginning(uint8_t mediaPlayer, bool atBeginning) {
			 ...
			 * clipFrame 	
			 */
			void ATEMext::setClipPlayerClipFrame(uint8_t mediaPlayer, uint16_t clipFrame) {
			 ...
			 * mediaPlayer 	0: Media Player 1, 1: Media Player 2
			 */
			uint8_t ATEMext::getMediaPlayerSourceStillIndex(uint8_t mediaPlayer) {
			 ...
			 * mediaPlayer 	0: Media Player 1, 1: Media Player 2
			 */
			uint8_t ATEMext::getMediaPlayerSourceClipIndex(uint8_t mediaPlayer) {
			 ...
			 * type 	1: Still, 2: Clip
			 */
			void ATEMext::setMediaPlayerSourceType(uint8_t mediaPlayer, uint8_t type) {
			 ...
			 */
			void ATEMext::setMediaPlayerSourceStillIndex(uint8_t mediaPlayer, uint8_t stillIndex) {
			 ...
			 */
			void ATEMext::setMediaPlayerSourceClipIndex(uint8_t mediaPlayer, uint8_t clipIndex) {
			 ...
			 */
			void ATEMext::setMediaPoolStorageClip1MaxLength(uint16_t clip1MaxLength) {
			 ...
			 * clipBank 	0-1: Clip Bank
			 */
			char *  ATEMext::getMediaPlayerClipSourceFileName(uint8_t clipBank) {
			 ...
			 * clipBank 	0-1: Clip Bank
			 */
			uint16_t ATEMext::getMediaPlayerClipSourceFrames(uint8_t clipBank) {
			 ...
			 */
			bool ATEMext::getMediaPlayerAudioSourceIsUsed(uint8_t clipBank) {
			 ...
			 * clipBank 	1-2: Clip Bank
			 */
			char *  ATEMext::getMediaPlayerAudioSourceFileName(uint8_t clipBank) {
			 ...
			 * borderOuterWidth 	0-1600: 0-16.00
			 */
			void ATEMext::setSuperSourceBorderOuterWidth(uint16_t borderOuterWidth) {
			 ...
			 * borderInnerWidth 	0-1600: 0-16.00
			 */
			void ATEMext::setSuperSourceBorderInnerWidth(uint16_t borderInnerWidth) {
			 ...
			 * borderBevelSoftness 	0-100: 0.0-1.0
			 */
			void ATEMext::setSuperSourceBorderBevelSoftness(uint8_t borderBevelSoftness) {
			 ...
			 * borderBevelPosition 	0-100: 0.0-1.0
			 */
			void ATEMext::setSuperSourceBorderBevelPosition(uint8_t borderBevelPosition) {
			 ...
			 * borderSaturation 	0-1000: 0-100%
			 */
			void ATEMext::setSuperSourceBorderSaturation(uint16_t borderSaturation) {
			 ...
			 * lightSourceDirection 	0-3590: 0-359 Degrees
			 */
			void ATEMext::setSuperSourceLightSourceDirection(uint16_t lightSourceDirection) {
			 ...
			 * lightSourceAltitude 	10-100: 10-100
			 */
			void ATEMext::setSuperSourceLightSourceAltitude(uint8_t lightSourceAltitude) {
			 ...
			 * box 	0-3: Box 1-4
			 */
			uint16_t ATEMext::getSuperSourceBoxParametersInputSource(uint8_t box) {
			 ...
			 * box 	0-3: Box 1-4
			 */
			uint16_t ATEMext::getSuperSourceBoxParametersCropTop(uint8_t box) {
			 ...
			 * box 	0-3: Box 1-4
			 */
			uint16_t ATEMext::getSuperSourceBoxParametersCropBottom(uint8_t box) {
			 ...
			 * box 	0-3: Box 1-4
			 */
			uint16_t ATEMext::getSuperSourceBoxParametersCropLeft(uint8_t box) {
			 ...
			 * box 	0-3: Box 1-4
			 */
			uint16_t ATEMext::getSuperSourceBoxParametersCropRight(uint8_t box) {
			 ...
			 * enabled 	Bit 0: On/Off
			 */
			void ATEMext::setSuperSourceBoxParametersEnabled(uint8_t box, bool enabled) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersInputSource(uint8_t box, uint16_t inputSource) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersCropped(uint8_t box, bool cropped) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersCropTop(uint8_t box, uint16_t cropTop) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersCropBottom(uint8_t box, uint16_t cropBottom) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersCropLeft(uint8_t box, uint16_t cropLeft) {
			 ...
			 */
			void ATEMext::setSuperSourceBoxParametersCropRight(uint8_t box, uint16_t cropRight) {
			 ...
			 * audioSource 	(See audio source list)
			 */
			bool ATEMext::getAudioMixerInputFromMediaPlayer(uint16_t audioSource) {
			 ...
			 * audioSource 	(See audio source list)
			 */
			uint8_t ATEMext::getAudioMixerInputPlugtype(uint16_t audioSource) {
			 ...
			 * audioSource 	(See audio source list)
			 */
			uint8_t ATEMext::getAudioMixerInputMixOption(uint16_t audioSource) {
			 ...
			 * volume 	0-65381: (DB)
			 */
			void ATEMext::setAudioMixerInputVolume(uint16_t audioSource, uint16_t volume) {
			 ...
			 */
			void ATEMext::setAudioMixerMonitorSoloInput(uint16_t soloInput) {
			 ...
			 */
			uint16_t ATEMext::getAudioMixerLevelsSourceOrder(uint16_t sources) {
			 ...
			 */
			void ATEMext::setResetAudioMixerPeaksInputSource(uint16_t inputSource) {
			 ...
			 * sources 	0-24: Number of
			 */
			uint16_t ATEMext::getAudioMixerTallyAudioSource(uint16_t sources) {
			 ...
			 */
			uint16_t ATEMext::getTallyBySourceVideoSource(uint16_t sources) {
