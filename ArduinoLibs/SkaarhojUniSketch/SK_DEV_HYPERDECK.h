...
uint16_t evaluateAction(const uint8_t devIndex, const uint16_t actionPtr, const uint8_t HWc, const uint8_t actIdx, const bool actDown, const bool actUp, int16_t pulses, const int16_t value, uint8_t HWcType) {
  uint16_t retVal = 0;
  if (actDown || actUp) {
