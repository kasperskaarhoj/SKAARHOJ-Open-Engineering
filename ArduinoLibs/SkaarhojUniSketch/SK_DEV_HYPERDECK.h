...
uint16_t evaluateAction(const uint8_t devIndex, const uint16_t actionPtr, const uint8_t HWc, const uint8_t actIdx, const bool actDown = false, const bool actUp = false, int16_t pulses = 0, const int16_t value = 0) {
  uint16_t retVal = 0;
  if (actDown || actUp) {
