/*****************
 * This example will run the LED test sequence on 4 SkaarhojUHB boards on the I2C bus (if they exist)
...
// All related to library "SkaarhojUHB":
#include "Wire.h"
#include "MCP23017.h"
#include "PCA9685.h"
...
SkaarhojUHB boardArray[] = {
  SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB(), SkaarhojUHB()};
...
void setup() { 
  ...
  // Always initialize Wire before setting up the SkaarhojUHB class!
  Wire.begin();
 ...
 */
void buttonPressSession(uint8_t bDown, SkaarhojUHB &board)  {
  if (bDown)  {
