/*****************
 * This example will first run the LED test sequence on SkaarhojUHB board with address 0 on the I2C bus 
...
void setup() { 
  ...
  // Set up the board:
  board.begin(0);  // Address 0, dip-switch on board is OFF for both 1 and 2
