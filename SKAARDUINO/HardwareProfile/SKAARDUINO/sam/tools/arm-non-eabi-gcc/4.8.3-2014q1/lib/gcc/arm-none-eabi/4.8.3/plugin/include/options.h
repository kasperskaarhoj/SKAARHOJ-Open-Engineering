...
enum opt_code
{
  ...
  OPT_mnew_generic_costs = 1057,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1058,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1059,     /* -mpic-data-is-text-relative */
  ...
  OPT_mslow_flash_data = 1064,               /* -mslow-flash-data */
